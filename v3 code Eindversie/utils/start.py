...
class Start():
    ...
    def clock_fonts(file_name):
        ...
        # Stopt de fonts in een variabele
        clock_font_0 = pygame.font.Font(os.path.join('utils', 'fonts', file_name), 180) #general_font
        clock_font_1 = pygame.font.Font(os.path.join('utils', 'fonts', file_name), 180) #general_font
        clock_font_2 = pygame.font.Font(os.path.join('utils', 'fonts', file_name), 156) #general_font
        clock_font_3 = pygame.font.Font(os.path.join('utils', 'fonts', file_name), 132) #general_font
        clock_font_4 = pygame.font.Font(os.path.join('utils', 'fonts', file_name), 108) #general_font
        clock_font_5 = pygame.font.Font(os.path.join('utils', 'fonts', file_name), 84) #general_font
